...
// Validate ../../src/app/payments/return/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/payments/return">> = Specific
  const handler = {} as typeof import("../../src/app/payments/return/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../src/app/api/payments/robokassa/result/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/payments/robokassa/result">> = Specific
  const handler = {} as typeof import("../../src/app/api/payments/robokassa/result/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

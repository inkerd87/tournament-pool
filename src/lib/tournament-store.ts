...
const SEED: Omit<Tournament, "registeredCount">[] = [
  {
    ...
    status: "recruiting",
    format: "5v5, BO1 — Вознаграждение 12 000 ₽",
    description:
  ...
  },
  {
    ...
    status: "recruiting",
    format: "5v5, Captains Mode — Вознаграждение 12 000 ₽",
    description:
      "Командные киберспортивные соревнования 5 на 5 (2 команды по 5 игроков, минимум 10 участников). Оплата организационных услуг 1 500 ₽ с игрока (судейство, платформа, подбор оппонентов). Фиксированное вознаграждение победившей команде 12 000 ₽ (по 2 400 ₽ каждому игроку) учреждено организатором соревнований за спортивные достижения и не зависит от взносов.",
    entryFeeRub: 1500,
    prizePoolRub: 12000,
  ...
  },
  {
    ...
    status: "recruiting",
    format: "Solo, 1 игра (быстрое вознаграждение)",
  ...
  },
  {
    ...
    status: "recruiting",
    format: "Solo, 1 катка (Премиум вознаграждение 28 000 ₽)",

            ...
            .map(t => {
              ...
              return {
                ...
                format: isCsOrDota
                  ...
                  : (isPubgPremium ? 'Solo, 1 соревнование' : t.format),
                description: isCsOrDota
                  ...
                  : (isPubgPremium
                      ? 'Премиум одиночные соревнования до 100 игроков (старт от 50 участников). Оплата организационных услуг 1 000 ₽ (судейство, серверные мощности, модерация лобби). Фиксированный наградной фонд 28 000 ₽ учреждён организатором (1 место: 15 000 ₽, 2 место: 8 000 ₽, 3 место: 5 000 ₽) и не формируется из взносов.'
                      : t.description),
                entryFeeRub,
                prizePoolRub,
                prizes,

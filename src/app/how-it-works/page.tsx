    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      <div className="mt-12 rounded-xl border border-amber-500/20 bg-amber-500/5 p-6 text-sm text-amber-100/90">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-5 text-amber-100/75">
          <li>
            Приём денег от физлиц требует подключения эквайринга (Robokassa,
            ЮKassa и т.п.) и договора с вашим юрлицом или ИП.
          </li>
          <li>
          ...
          <li>
            Оплата взносов и пополнение кошелька работают через Robokassa при

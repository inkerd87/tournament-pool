  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      <section className="mt-10 space-y-3 leading-relaxed text-zinc-300">
        ...
        <p>
          Оператором персональных данных является владелец домена, на котором
          размещён {SITE_NAME}. Реквизиты юридического лица или ИП (наименование,
          ИНН, адрес, email для запросов субъектов) публикуются здесь при
          коммерческом запуске и подключении эквайринга.
        </p>
      </section>

    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      <section className="mt-8 space-y-3 leading-relaxed text-zinc-300">
        ...
        <ul className="list-disc space-y-2 pl-5">
          <li>
            ...
            внутренний идентификатор, дата создания, баланс личного кабинета.
          </li>
          <li>
            <strong className="text-white">Участие в соревновании:</strong> ник в игре (обязан строго совпадать с никнеймом при регистрации),
            игровой идентификатор (Steam / Riot / PUBG ID и аналоги), email,
            время оплаты организационных услуг.
          </li>
          <li>
      ...
      <section className="mt-8 space-y-3 leading-relaxed text-zinc-300">
        ...
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>регистрация на соревнование и идентификация игрока в лобби (по совпадению никнейма);</li>
          <li>приём оплаты организационных услуг и пополнения баланса;</li>
          <li>показ баланса, списка регистраций и истории соревнований;</li>
          <li>проведение соревнований организатором (доступ в комнату, результаты);</li>
        ...
        <p>
          ...
          соревнованиях, баланс личного кабинета) и согласие субъекта, выраженное при входе или
      ...
      <section className="mt-8 space-y-3 leading-relaxed text-zinc-300">
        ...
        <p>
          Организатор соревнований видит данные регистрации, необходимые для запуска
          соревнований (ник, игровой ID). Мы не продаём персональные данные и не
      ...
      <section className="mt-8 space-y-3 leading-relaxed text-zinc-300">
        ...
        <p>
          Оплата организационных услуг соревнований предназначена для лиц, обладающих дееспособностью для
      ...
      <p className="mt-12 text-sm text-zinc-500">
        Как устроены соревнования и выплаты — на странице{" "}

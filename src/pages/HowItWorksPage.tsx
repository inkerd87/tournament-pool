      ...
      <div className="mt-12 space-y-12">
        <section className="space-y-4">
          ...
          <p className="leading-relaxed text-zinc-300">
            ...
            Участие в соревнованиях предусматривает оплату организационных услуг: судейство матчей, предоставление игровой платформы, модерация лобби и автоматизированный подбор равных оппонентов.
          </p>
          <p className="leading-relaxed text-zinc-300">
        ...
        <section className="space-y-4">
          ...
          <p className="leading-relaxed text-zinc-300">
            Победителей соревнований ждут фиксированные денежные награды. Наградной фонд учреждается организатором соревнований <strong>исключительно из собственных средств</strong> за спортивные достижения и <strong>не зависит от количества участников или собранных орг. платежей</strong>:
          </p>
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div className="rounded-xl border border-white/10 bg-white/5 p-5">
              ...
              <p className="mt-2 text-xs text-zinc-300 leading-relaxed">
                Одиночные соревнования на выбывание. Фиксированный наградной фонд от организатора: 2 200 ₽ в стандартных матчах и 28 000 ₽ в Премиум-матчах (1-е место — 15 000 ₽, 2-е место — 8 000 ₽, 3-е место — 5 000 ₽).
              </p>
            </div>
          </div>
        ...
        <section className="space-y-4 rounded-2xl border border-amber-500/25 bg-amber-950/15 p-6">
          ...
          <p className="leading-relaxed text-zinc-400 text-sm">
            При регистрации на соревнование участник подтверждает своё совершеннолетие. Организатор оставляет за собой право запросить подтверждение возраста победителей перед вручением наград.
          </p>
        </section>
      </div>

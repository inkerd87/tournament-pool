    ...
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
      ...
      <div className="mt-12 space-y-12">
        ...
        <section className="space-y-4">
          ...
          <p className="leading-relaxed text-zinc-300">
            Победителей соревнований ждут фиксированные денежные награды. Вознаграждение учреждается организатором соревнований <strong>исключительно из собственных средств</strong> за спортивные достижения и <strong>не зависит от количества участников или собранных орг. платежей</strong>:
          </p>
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div className="rounded-xl border border-white/10 bg-white/5 p-5">
              ...
              <p className="mt-2 text-xs text-zinc-300 leading-relaxed">
                Одиночные соревнования на выбывание. Фиксированное вознаграждение от организатора: 2 200 ₽ в стандартных соревнованиях и 28 000 ₽ в Премиум-соревнованиях (1-е место — 15 000 ₽, 2-е место — 8 000 ₽, 3-е место — 5 000 ₽).
              </p>
            </div>
          </div>

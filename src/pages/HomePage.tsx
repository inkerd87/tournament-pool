      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-20 sm:px-6 sm:py-28">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <Link to="/tournaments" className="btn-primary px-6 py-3">
              Смотреть турниры
            </Link>
            <Link to="/how-it-works" className="btn-secondary px-6 py-3">
              Правила и выплаты
            </Link>
          </div>
        </div>
      ...
      <section className="border-t border-white/10 bg-[#0a0d12]">
        <div className="mx-auto grid max-w-6xl gap-8 px-4 py-16 sm:grid-cols-3 sm:px-6">
          {[
            ...
            {
              title: "3. Призы",
              text: `Призы за 1–3 места: ${formatRub(PRIZE_BY_PLACE[1])}, ${formatRub(PRIZE_BY_PLACE[2])}, ${formatRub(PRIZE_BY_PLACE[3])}.`,
            },
          ].map((step) => (
            <div
              key={step.title}

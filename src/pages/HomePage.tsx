      ...
      <section className="border-t border-white/10 bg-[#0a0d12]">
        <div className="mx-auto grid max-w-6xl gap-4 sm:gap-6 px-4 py-10 sm:grid-cols-3 sm:px-6 sm:py-16">
          {[
            ...
            {
              step: "03",
              title: "Награды организатора",
              text: "Победителей соревнований ждут фиксированные денежные награды от организатора за спортивные достижения (не зависящие от взносов участников). Выплата через СБП до 24 часов.",
            },
          ].map((item) => (
            <div
              key={item.step}

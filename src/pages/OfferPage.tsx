      ...
      <div className="surface-card p-6 sm:p-10 space-y-8">
        ...
        <section className="space-y-3 text-xs sm:text-sm leading-relaxed text-zinc-300">
          ...
          <div className="space-y-2 pt-2">
            ...
            <p>3.2.6. При создании учетной записи и регистрации на соревнования Заказчик обязан предоставить действующий <strong>номер мобильного телефона</strong>. Указание номера телефона является обязательным условием для идентификации участника, обеспечения связи с организаторами и перечисления денежных наград через Систему быстрых платежей (СБП).</p>
        ...
        <section className="space-y-3 text-xs sm:text-sm leading-relaxed text-zinc-300">
          ...
          <p>4.5. Выплата денежных наград победителям соревнований осуществляется Исполнителем в безналичном порядке (через Систему быстрых платежей (СБП) или переводом на банковскую карту РФ) в срок до 24 часов (до одних суток) с момента завершения соревнований и фиксации официальных итогов соревнований.</p>
          ...
          <p>4.7. Денежные средства, внесенные Заказчиком на баланс Личного кабинета, учитываются в рублях РФ и расходуются исключительно на оплату услуг по организации участия в выбранных киберспортивных соревнованиях.</p>
        </section>

      ...
      <div className="surface-card p-6 sm:p-10 space-y-8">
        <div>
          ...
          <p className="mt-2 text-xs text-zinc-500">
            Редакция действует с 1 сентября 2026 г. · Сайт: <a href="https://nightbyteonline.ru" className="text-cyan-400 hover:underline">https://nightbyteonline.ru/</a>
          </p>
        </div>
        ...
        <section className="space-y-3 text-xs sm:text-sm leading-relaxed text-zinc-300">
          ...
          <div className="rounded-xl border border-white/10 bg-black/40 p-4 space-y-2 text-xs">
            ...
            <p><strong>Сайт Исполнителя в сети «Интернет»</strong> — совокупность программ для электронных вычислительных машин и иной информации, содержащейся в информационной системе, доступ к которой обеспечивается посредством сети «Интернет» по доменному имени и сетевому адресу: https://nightbyteonline.ru/</p>
        ...
        <section className="space-y-3 text-xs sm:text-sm leading-relaxed text-zinc-300">
          ...
          <p className="text-xs text-zinc-500">Данный перечень неисчерпывающий, могут быть и другие действия, которые ясно выражают намерение лица принять предложение контрагента.</p>
        </section>
        ...
        <section className="space-y-3 text-xs sm:text-sm leading-relaxed text-zinc-300">
          ...
          <p>4.4. Все расчеты по Договору производятся в безналичном порядке.</p>
        ...
        <section className="space-y-3 text-xs sm:text-sm leading-relaxed text-zinc-300">
          ...
          <p>9.2. В случае возникновения спора, который может возникнуть между Сторонами в ходе исполнения ими своих обязательств по Договору, заключенному на условиях настоящей Оферты, Стороны обязаны урегулировать спор мирным путем до начала судебного разбирательства. Судебное разбирательство осуществляется в соответствии с законодательством Российской Федерации. Досудебный порядок урегулирования спора является обязательным.</p>
          <p>9.3. В качестве языка Договора, заключаемого на условиях настоящей Оферты, а также языка взаимодействия Сторон, Стороны определили русский язык.</p>
          <p>9.4. Все документы, подлежащие предоставлению в соответствии с условиями настоящей Оферты, должны быть составлены на русском языке.</p>
          ...
          <p>9.6. Ссылки на другие веб-сайты размещены исключительно в целях информирования, и Исполнитель не несет ответственности за их содержание.</p>
        </section>

        <section className="space-y-3 text-xs sm:text-sm leading-relaxed text-zinc-300 rounded-2xl border border-cyan-500/20 bg-cyan-950/20 p-5 sm:p-6">
          ...
          <div className="grid gap-2 sm:grid-cols-2 text-xs">
            <div>
              ...
              <p className="font-mono font-bold text-white select-all">910408161157</p>
            </div>
            <div>
              <p className="text-zinc-500">Контактный телефон</p>
              <p className="font-mono font-bold text-cyan-300 select-all">+7 978 784-74-14</p>
            </div>
            <div>
              <p className="text-zinc-500">Контактный e-mail</p>

        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="mt-0.5 text-[11px] sm:text-xs text-zinc-400">
              {pubgMode === 'premium'
                ? 'Премиум PUBG: орг. услуги 1 000 ₽ (судейство, лобби, платформа) · наградной фонд от организатора 28 000 ₽'
                : 'Обычный PUBG: орг. услуги 100 ₽ (судейство, платформа, подбор оппонентов) · наградной фонд от организатора 2 200 ₽'}
            </p>
          </div>
        </div>

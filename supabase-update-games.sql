...
values
  (
    ...
    'recruiting',
    'Solo, 1 игра (Премиум фонд 28 000 ₽)',
    'Премиум одиночные соревнования на 100 игроков: 1 игра — топ-3 делят наградной фонд 28 000 ₽ (1 место: 15 000 ₽, 2 место: 8 000 ₽, 3 место: 5 000 ₽). Орг. сбор 1 000 ₽.'
  ),
  (
    'warzone-solo-001',
    ...
    'Соревнования по Call of Duty: Warzone откроются скоро. Регистрация и наградной фонд станут доступны в ближайшее время.'
  ),
  (
    'fortnite-solo-001',
    ...
    'Соревнования по Fortnite откроются скоро. Регистрация и наградной фонд станут доступны в ближайшее время.'
  )

...
-- 5. Обновляем соревнования CS2 и Dota 2 под схему 5v5 (10 человек, 1 500 ₽ взнос, 12 000 ₽ победителю)
update public.tournaments
set
  title = 'CS2 5v5 Cash Clash #1',
  max_players = 10,
  format = '5v5, BO1 — Регламент соревнований',
  description = 'Командные киберспортивные соревнования 5 на 5 (2 команды по 5 игроков). Оплата орг. услуг 1 500 ₽ с игрока. Фиксированное вознаграждение победившей команде 12 000 ₽ (по 2 400 ₽ на каждого игрока команды) за спортивные достижения!'
where game = 'cs2';
...
-- 6. Добавляем / обновляем соревнования по Warzone и Fortnite со статусом 'soon' (Скоро)
...
values
  (
    ...
    'recruiting',
    'Solo, 1 игра (Премиум вознаграждение 28 000 ₽)',
    'Премиум одиночные соревнования на 100 игроков: 1 игра — топ-3 делят вознаграждение 28 000 ₽ (1 место: 15 000 ₽, 2 место: 8 000 ₽, 3 место: 5 000 ₽). Орг. сбор 1 000 ₽.'
  ),
  (
    'warzone-solo-001',
    ...
    'Соревнования по Call of Duty: Warzone откроются скоро. Регистрация и размер вознаграждения станут доступны в ближайшее время.'
  ),
  (
    'fortnite-solo-001',
    ...
    'Соревнования по Fortnite откроются скоро. Регистрация и размер вознаграждения станут доступны в ближайшее время.'
  )
...
-- 7. Включаем REALTIME (трансляция изменений через WebSocket)
do $$
begin
  begin
...
-- RLS политики для гарантированной трансляции Realtime и доступа
